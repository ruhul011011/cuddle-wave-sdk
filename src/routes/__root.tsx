...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Live football streams, schedules and highlights from every major league." },
      ...
      { name: "twitter:title", content: "Football Streaming — Watch Live Football Online" },
      { name: "twitter:description", content: "Live football streams, schedules and highlights from every major league." },
